  ...
  <footer>
    <div class="footer-wrap container">
      ...
      <div class="footer-col">
        ...
        <ul>
          <li class="footer-item">Αρχική</li>
          <li class="footer-item">POPZ</li>
          <li class="footer-item">ROCK</li>
          <li class="footer-item">Δίκτυο</li>
          <li class="footer-item">Επικοινωνία</li>
        </ul>
      </div>
      <div class="footer-col">
